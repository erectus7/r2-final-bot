...
const ASSET_ACQUISITION_CONFIG = { ENABLED: true, SWAP_LIST: [ { LABEL: "ACQUISITION (1/2): Buy R2 from USDC", AMOUNT_IN: randomizeAmount('1200', 5), ROUTER: ROUTERS.V2_OLD, PATH: [TOKEN_ADDRESSES.USDC, TOKEN_ADDRESSES.R2] }, { LABEL: "ACQUISITION (2/2): Buy R2USD from R2", AMOUNT_IN: randomizeAmount('2000', 5), ROUTER: ROUTERS.V2_OLD, PATH: [TOKEN_ADDRESSES.R2, TOKEN_ADDRESSES.R2USD] } ] };
const LIQUIDITY_CONFIG = { ENABLED: true, PAIRS: [ { tokenA: 'R2', tokenB: 'R2USD', amountA: '1200', amountB: '400', ROUTER: ROUTERS.V2_OLD }, { tokenA: 'R2', tokenB: 'USDC', amountA: '300', amountB: '300', ROUTER: ROUTERS.V2_OLD } ] };
